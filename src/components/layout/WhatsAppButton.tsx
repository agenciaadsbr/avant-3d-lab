...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/5551993196828?text=Olá! Vim pelo site da AVANT 3D LAB e gostaria de saber mais sobre as miniaturas."
      target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp"
      style={{
        position: "fixed", bottom: "1.5rem", right: "1.5rem", zIndex: 999,
        width: 56, height: 56, backgroundColor: "#25D366", borderRadius: "50%",
        display: "flex", alignItems: "center", justifyContent: "center",
        boxShadow: "0 4px 20px rgba(37,211,102,0.4)", transition: "transform 0.2s, box-shadow 0.2s", textDecoration: "none",
      }}
